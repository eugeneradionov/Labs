...
PaintBox1.Canvas.Clear;
  ...
  if Angle1 = nil then
    begin
      Angle1 := TAngle.Create(0, 0, 105, 105);
  ...
  Angle1.Drow(Angle1.Canvas);
  end
  else
  begin
       if Angle2 = nil then
    begin
      Angle2 := TAngle.Create(0, 0, 105, 105);
...
begin
  ...
  Canvas.MoveTo(Xpos,Ypos+50);
  Canvas.LineTo(Xpos+105, Ypos+50);
  Canvas.MoveTo(Xpos+50,Ypos+100);
  Canvas.LineTo(Xpos+50, Ypos);
  Canvas.Pen.Width:=1;
